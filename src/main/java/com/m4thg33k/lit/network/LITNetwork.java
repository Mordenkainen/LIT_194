...
public class LITNetwork{

    public static LITNetwork instance = new LITNetwork();
    ...
    public LITNetwork(){
        network = NetworkRegistry.INSTANCE.newSimpleChannel(LIT.MODID);
    ...
    public static void sendToClients(WorldServer world, BlockPos pos, BasePacket packet)
    {
        ...
        for (EntityPlayer player : world.playerEntities)
        {
            ...
            {
                LITNetwork.sendTo(packet, playerMP);
            }
        }
    }
